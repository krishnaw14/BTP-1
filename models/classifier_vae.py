...
class Classifier(nn.Module):
	def __init__(self, config):
		...
		self.hidden_dim = config['model']['classifier']['hidden_dim']
		self.out_dim = config['model']['classifier']['out_dim']
		self.num_layers = config['model']['classifier']['num_layers'] # 5
		self.bn = config['model']['classifier']['bn']
...
class ClassifierVAE(nn.Module):
	...
	def __init__(self, config, device):
		...
		# self.classifier_num_layers = config['model']['classifier']['num_layers']
		# self.classifier_hidden_dim = config['model']['classifier']['hidden_dim']
		# self.classifier_out_dim = config['model']['classifier']['out_dim']
		# self.classifier_bn = config['model']['classifier']['batch_norm']
